#[rustfmt::skip]
pub const SOURCES: [(&'static str, &'static str); 15] = [(r#"/home/simon/dev/rym/crates/tests/src/integration/test_hello_world.rym"#, r#"println("Hello World!")
...
// {
"#), (r#"/home/simon/dev/rym/crates/tests/src/integration/ice.rym"#, r#"fn max(a, b) { if a > b { a } else { b } }
